...
(function (WatcherType) {
    WatcherType["POLLING"] = "polling";
    WatcherType["WATCHMAN"] = "watchman";
    WatcherType["NODE"] = "node";
...
async function getBuilder(options) {
    ...
    return new index_1.default.Builder(instance);
}
